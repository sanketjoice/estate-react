  ...
  return <section className="h-full max-h-[640px] mb-8 xl:mb-24">
    <div className="flex flex-col lg:flex-row">
      <div className="lg:ml-8 xl:ml-[135px] flex flex-col  items-center lg:items-start text-center lg:text-left justify-center flex-1 px-4 lg:px-0">
        ...
        <p className="max-w-[480px] mb-8">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veniam voluptas modi nemo voluptatibus eaque, iure dicta aut similique voluptatem obcaecati.</p>
      </div>
